...
def genOpenCL(input,ex,ey,dx,dy):
    ...
    if input['isSolid'] == 1:
        ...
        f.write('                    flux_out += inx*feqW[inv_i]*ux/dx[ix] + iny*feqW[inv_i]*uy/dy[iy];                // flux out of solid, back along inverse velocity\n')
        f.write('                }\n')
        f.write('            }\n')
        f.write('        }\n\n')
        ...
        f.write('             F_FLUX_X(ix,iy,i) = alpha*ux*feqW[i];\n')
        f.write('             F_FLUX_Y(ix,iy,i) = alpha*uy*feqW[i];\n\n')
        f.write('             H_FLUX_X(ix,iy,i) = alpha*ux*heqW[i];\n')
        f.write('             H_FLUX_Y(ix,iy,i) = alpha*uy*heqW[i];\n')
        f.write('        }\n')
        f.write('    }\n')
        f.write('}\n')
