...
def genOpenCL(input,ex,ey,dx,dy):
    ...
    if input['FMETHOD'] == 0:
        ...
        f.write('    (*flux_x) = clNND(Sx,exi);\n')
        f.write('    (*flux_y) = clNND(Sy,eyi);\n\n')
    elif input['FMETHOD'] == 1:
        f.write('    // WENO5\n')
        f.write('    double Sx[5];\n')
        f.write('    double Sy[5];\n\n')
        f.write('    clStencil(f, Sx, Sy, i, cell, bnd);\n\n')
        f.write('    (*flux_x) = clWENO5(Sx, exi);\n')
        f.write('    (*flux_y) = clWENO5(Sy, eyi);\n\n')
    f.write('}\n\n')
    ...
    f.write('{\n')
    f.write('    // calculates the combined flux given all the fluxes out of each node, input is kg, output is kg/m^3\n\n')
    f.write('    if (i == 0) {\n\n')
    f.write('        return 0;\n')
    f.write('    }\n')
    f.write('    else {\n')
    ...
    f.write('        // calculate volumes of fluxes\n')
    ...
    f.write('        F_FLUX_X(ix,iy,i) = vol*flux_fx;\n')
    f.write('        F_FLUX_Y(ix,iy,i) = vol*flux_fy;\n\n')
    f.write('        H_FLUX_X(ix,iy,i) = vol*flux_hx;\n')
    f.write('        H_FLUX_Y(ix,iy,i) = vol*flux_hy;\n')
    f.write('    }\n')
    f.write('}\n\n')
    
    
    f.write('////////////////////////////////////////////////////////////////////////////////\n')
    f.write('// KERNEL: clMacroProp\n')
    f.write('////////////////////////////////////////////////////////////////////////////////\n\n')
    ...
    if input['isSolid'] == 1:
        ...
        f.write('                    flux_in += inx*F_FLUX_X(xm1,ym1,i)/dx[ix] + iny*F_FLUX_Y(xm1,ym1,i)/dy[iy];        // flux into solid\n\n')
        f.write('                    // absolute value of velocities\n')
        f.write('                    ux = fabs(ex[inv_i]);    \n')
        f.write('                    uy = fabs(ey[inv_i]);\n\n')
        f.write('                    flux_out += inx*feqW[inv_i]*ux*vol/dx[ix] + iny*feqW[inv_i]*uy*vol/dy[iy];                // flux out of solid, back along inverse velocity\n')
        f.write('                }\n')
        f.write('            }\n')
        f.write('        }\n\n')
        ...
        f.write('             F_FLUX_X(ix,iy,i) = alpha*ux*vol*feqW[i];\n')
        f.write('             F_FLUX_Y(ix,iy,i) = alpha*uy*vol*feqW[i];\n\n')
        f.write('             H_FLUX_X(ix,iy,i) = alpha*ux*vol*heqW[i];\n')
        f.write('             H_FLUX_Y(ix,iy,i) = alpha*uy*vol*heqW[i];\n')
        f.write('        }\n')
        f.write('    }\n')
        f.write('}\n')
