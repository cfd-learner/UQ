...
def genOpenCL(input,ex,ey,dx,dy):
    ...
    f.write('        F_FLUX_X(ix,iy,i) = dy[iy]*flux_fx;\n')
    f.write('        F_FLUX_Y(ix,iy,i) = dx[ix]*flux_fy;\n\n')
    f.write('        H_FLUX_X(ix,iy,i) = dy[iy]*flux_hx;\n')
    f.write('        H_FLUX_Y(ix,iy,i) = dx[ix]*flux_hy;\n')
    f.write('    }\n')
    f.write('}\n\n')
    ...
    if input['isSolid'] == 1:
        ...
        f.write('        double areaX = dy[iy]; // assume dz = 1\n')
        f.write('        double areaY = dx[ix];\n')
